...
.
├── data/
│   └── panel_iraq_2016_2020.csv     # assembled province-month panel
├── src/
│   ├── build_panel.py               # constructs the panel from ACLED + GTD
│   ├── models.py                    # distributed-lag FE specifications
│   └── robustness.py                # subsample / robustness checks
├── notebooks/
